...
public class CarritoHolderP extends RecyclerView.ViewHolder{
    private String TAG = CarritoHolderP.class.getName();
    private ItemResumenBindingImpl binding;


    public CarritoHolderP(@NonNull ItemResumenBindingImpl binding) {
